                ...
                return (
                  <Card key={index} className="border-2 bg-white hover:shadow-lg transition-all duration-300 group">
                    <CardContent className="p-8 text-center">
                      <div className="w-16 h-16 rounded-full bg-emerald-50 flex items-center justify-center mx-auto mb-4 transition-all duration-300 group-hover:scale-110 group-hover:bg-emerald-100 group-hover:shadow-md">
                        <Icon className="w-8 h-8 text-emerald-600 transition-colors duration-300 group-hover:text-emerald-700" />
                      </div>
